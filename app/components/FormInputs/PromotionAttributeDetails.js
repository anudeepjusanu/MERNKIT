...
function PromotionAttributeDetails(props) {
  const [rowData, setRowData] = useState(props.promotionAttributeData || []);
...
export default withStyles(styles)(PromotionAttributeDetails);
